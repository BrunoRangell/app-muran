...
export async function fetchMetaApiData(accountId: string, accessToken: string, customBudget: any = null) {
  ...
  try {
    ...
    const campaignsUrl = `https://graph.facebook.com/v24.0/act_${accountId}/campaigns?fields=id,name,status,effective_status,daily_budget&access_token=${accessToken}&limit=100`;
