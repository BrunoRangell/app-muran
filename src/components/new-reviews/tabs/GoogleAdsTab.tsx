...
export function GoogleAdsTab({ onRefreshCompleted, isActive }: GoogleAdsTabProps) {
  ...
  if (!isActive) {
    return <div className="hidden">Aba Google Ads</div>;
  }
