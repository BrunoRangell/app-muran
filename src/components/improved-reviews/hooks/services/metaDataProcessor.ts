...
export interface ProcessedMetaClientData {
  id: string;
  company_name: string;
  status: string;
...
export function processMetaClientAccount(
  client: any, 
  account: any, 
  reviews: any[], 
...
export function createMetaClientWithoutAccount(client: any): ProcessedMetaClientData {
  return {
    ...client,
