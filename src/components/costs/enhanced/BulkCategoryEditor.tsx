  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto flex flex-col">
        ...
        {/* Área de conteúdo com scroll próprio do DialogContent */}
        <div className="space-y-4 flex-1 px-1">
          ...
          <div>
            ...
            <div className="mt-2 max-h-16 overflow-y-auto space-y-1 p-2 bg-muted rounded-md">
              ...
              {COST_CATEGORIES.map((category) => {
                ...
                return (
                  <div 
                    key={category.id}
                    className={cn(
                      "flex items-start space-x-3 p-2 rounded-lg border cursor-pointer transition-colors",
