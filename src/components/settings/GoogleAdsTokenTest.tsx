...
export const GoogleAdsTokenTest = () => {
  ...
  const fetchTokens = async () => {
    ...
    try {
      ...
      toast({
        title: "Erro",
        description: error instanceof Error ? error.message : "Não foi possível buscar os tokens do Google Ads",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-xs text-gray-600">Sistema automatizado ativo (Acesso restrito a administradores)</span>
            </div>
          </div>
