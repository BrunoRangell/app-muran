...
import { BudgetInfoGrid } from "./dashboard/BudgetInfoGrid";
import { BudgetRecommendation } from "./dashboard/BudgetRecommendation";
import { CalculationError } from "./dashboard/CalculationError";
...
export const ClientReviewCard = ({ 
  ...
  const {
    ...
    idealDailyBudget,
    budgetDifference
  } = useClientBudgetCalculation(client, accountIdField);
