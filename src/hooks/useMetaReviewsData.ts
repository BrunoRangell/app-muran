...
export function useMetaReviewsData() {
  ...
  const { 
    ...
    queryFn: async () => {
      try {
        ...
        // 2. Buscar contas Meta dos clientes
        ...
        console.error('Erro ao buscar dados de revisões Meta:', error);
        throw error;
      }
    },
